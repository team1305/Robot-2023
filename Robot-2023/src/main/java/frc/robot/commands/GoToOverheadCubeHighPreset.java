...
public class GoToOverheadCubeHighPreset extends CommandBase {
  private final Arm m_arm;
  private final Wrist m_wrist;

  /** Creates a new GoToFloor. */
  public GoToOverheadCubeHighPreset(Arm arm, Wrist wrist) {
  ...
  public void initialize() {
    ...
    m_wrist.setSetpoint(WristPresets.overhead_cube_high);
  }
