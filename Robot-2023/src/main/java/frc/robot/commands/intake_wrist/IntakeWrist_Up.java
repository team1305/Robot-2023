...
public class IntakeWrist_Up extends CommandBase {

  private final IntakeWrist m_intakeWrist;


  /** Creates a new IntakeWrist_Manual. */
  public IntakeWrist_Up(IntakeWrist intakeWrist) {
    super();
  ...
  @Override
  public void execute() {
    SmartDashboard.getString(SmartDashboardConstants.INTAKE_WRIST_COMMAND, "Up");
    m_intakeWrist.setIntakeWristTarget(
      IntakeWristPresets.getHigherThan(
