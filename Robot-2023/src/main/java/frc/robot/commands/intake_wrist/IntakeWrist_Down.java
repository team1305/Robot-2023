...
public class IntakeWrist_Down extends CommandBase {

  private final IntakeWrist m_intakeWrist;


  /** Creates a new IntakeWrist_Manual. */
  public IntakeWrist_Down(IntakeWrist intakeWrist) {
    super();
  ...
  @Override
  public void execute() {
    SmartDashboard.getString(SmartDashboardConstants.INTAKE_WRIST_COMMAND, "Down");
    m_intakeWrist.setIntakeWristTarget(
      IntakeWristPresets.getLowerThan(
        m_intakeWrist.getIntakeWristTarget()
      )
    );
  }
