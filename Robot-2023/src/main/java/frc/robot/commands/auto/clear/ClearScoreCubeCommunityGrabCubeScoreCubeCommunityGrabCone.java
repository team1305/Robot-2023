...
public class ClearScoreCubeCommunityGrabCubeScoreCubeCommunityGrabCone extends SequentialCommandGroup {
  /** Creates a new TwoCubeBalance. */
  public ClearScoreCubeCommunityGrabCubeScoreCubeCommunityGrabCone(
    Drivebase drivebase,
    Arm arm,
    Wrist wrist,
    RollerIntake roller,
