...
public class BumpScoreCubeCommunityGrabCubeScoreCube extends SequentialCommandGroup {
  /** Creates a new TwoCubeBalance. */
  public BumpScoreCubeCommunityGrabCubeScoreCube(
    Drivebase drivebase,
    Arm arm,
    Wrist wrist,
    RollerIntake roller,
