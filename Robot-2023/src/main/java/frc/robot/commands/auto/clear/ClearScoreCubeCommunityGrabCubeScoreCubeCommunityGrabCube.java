...
public class ClearScoreCubeCommunityGrabCubeScoreCubeCommunityGrabCube extends SequentialCommandGroup {
  /** Creates a new TwoCubeBalance. */
  public ClearScoreCubeCommunityGrabCubeScoreCubeCommunityGrabCube(
    Drivebase drivebase,
    Arm arm,
    Wrist wrist,
    RollerIntake roller,
