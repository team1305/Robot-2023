...
public class ClearScoreCubeCommunityGrabCubeScoreCubeCommunityGrabConeBalance extends SequentialCommandGroup {
  /** Creates a new TwoCubeBalance. */
  public ClearScoreCubeCommunityGrabCubeScoreCubeCommunityGrabConeBalance(
    Drivebase drivebase,
    Arm arm,
    Wrist wrist,
    RollerIntake roller,
